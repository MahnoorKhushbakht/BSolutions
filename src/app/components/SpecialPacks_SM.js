        ...
        <div className='min-h-screen w-full'>
            ...
            <div className='grid grid-cols-1 place-content-center gap-4 place-items-center mt-10 mb-10'>
                {contentData.map((contentItem, idx) => (
                        <div
                            key={idx}
                            className='w-80 h-full shadow-md rounded-lg overflow-hidden bg-blue-950 cursor-pointer'
                        ...
                        >
                            ...
                            <div className='p-4 text-center'>
                                <a className='w-32 text-slate-900 hover:bg-slate-500 hover:text-white transition-colors hvr-grow rounded-md p-3 bg-white inline-block' href="/contact">
                                    Contact Us
                                </a>
                            </div>
                        </div>
