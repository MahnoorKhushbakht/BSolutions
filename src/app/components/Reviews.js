    ...
    return (
        <div className="min-h-full w-full flex flex-col items-center justify-center bg-blue-950 ">
            <div className="grid grid-cols-1 place-items-center place-content-center mt-5">
                ...
                <p data-aos="fade-down" className="font-semibold text-base md:text-lg text-center">Every customer is valuable to us. Here are the reviews of some of our customers who chose us.</p>
            </div>
